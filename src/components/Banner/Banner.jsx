...
const Banner = () => {
  return (
    <div lassName="min-h-[550px] flex justify-center items-center py-12 sm:py-0">
          ...
          <div className="flex flex-col justify-center gap-6 sm:pt-0">
            <div className="text-3xl sm:text-4xl font-bold">
              ...
              >
                ...
                Officia ex obcaecati tenetur voluptatem quo reiciendis ipsum
                perspiciatis excepturi! Vero fugiat amet doloribus similique
                commodi eligendi corpor.
              </p>
