...
const Navbar = () => {
  return (
    ...
    >
      {/* upper navbar */}
      <div className="bg-primary/40 py-3 sm:py-">
        <div
        ...
        >
          ...
          {/* search navbar and order button */}
          <div
            ...
            >
              <input
                ...
                className="w-[200px] sm:w-[200px] group-hover:w-[300px]
                 transaction-all duration-300 rounded-full border border-gray-300
      ...
      <div className="flex justify-center">
        ...
        <li className="list-none group relative cursor-pointer">
